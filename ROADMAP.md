...
| ID | 항목 |
|----|------|
| **R-ci** | GitHub Actions 매트릭스 (Linux/macOS/Windows × Python 3.10-3.13) 설정 |
| **R-pkg** | PyPI 배포 (`pip install polaris-mcfg`) — 현재 `pip install -e .` git 체크아웃만 |
| **R-bench** | 성능 회귀 벤치마크 — 큰 CJK 폰트 처리 시간 추적 |
